...
"""stream_shell.py provides the Synchronous Streaming Shell API for interactive shell sessions."""
import base64
import json
...
class StreamShellSync:
    """Synchronous Stream Shell API for interactive shell sessions."""
